---
title: "gitcreds-advanced"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{gitcreds-advanced}
...
In this case, you can add you githum.com credential with an arbitrary
...
You can also change it only for github.com:
    ...
    git config --global credential.github.com.authrority Basic
...
names, and all the others with their specific user and host names.
