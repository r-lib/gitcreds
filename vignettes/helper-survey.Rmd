...
-   This is supposed to support multiple users better, but it does not: <https://github.com/microsoft/Git-Credential-Manager-Core/issues/160#issuecomment-700058010>
...
2.  FIrst remove all your current credentials for the host you are targeting.
    E.g. for GitHub, search for "Internet Passwords" for github.com.
...
3.  Then add the credential that you want to use for "generic access".
    ...
    The user name for this credential does not matter, but you can choose something descriptive, e.g. "token", or "generic".
